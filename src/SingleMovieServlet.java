...
public class SingleMovieServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try (Connection conn = dataSource.getConnection()) {
            ...
            JsonObject movieObject = jsonArray.get(0).getAsJsonObject();
            String movieId = movieObject.get("movie_id").getAsString();

            // Call method to get additional data based on movie ID
            JsonObject movie_stars = Shared.getStarsInMovie(movieId, -1, conn, response, out);
            JsonObject movie_genres = Shared.getGenresInMovie(movieId, -1, conn, response, out);
